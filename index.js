...
const phillipe = new Person("Phillipe", 28);

phillipe.eat("Lasagna");
phillipe.eat("Lasagna");
phillipe.eat("Lasagna");
phillipe.eat("Lasagna");
phillipe.eat("Lasagna");
...
console.log(phillipe.stomach.length)
...
class Car {
  ...
  drive(distance) {
    let toEmpty = (this.milesPerGallon * this.tank);
    if (toEmpty < distance) {
      this.tank = 0;
      this.odometer += toEmpty;
